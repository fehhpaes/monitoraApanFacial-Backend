...
// Async IIFE - Aguarda configuração antes de iniciar servidor
(async () => {
  try {
  ...
  // Registrar rotas de alunos APÓS tentar conectar ao BD
  if (usingMongoDB) {
    app.use('/api/alunos', alunosRouter);
    console.log('✅ Rotas de alunos (MongoDB) registradas');
  } else {
  ...
  // Tratamento de erros (DEPOIS de todas as rotas reais)
  app.use(notFoundHandler);
  app.use(errorHandler);

  // Iniciar servidor (AGORA SIM, com todas as rotas registradas)
